...
using Abp.Hangfire;
using Abp.Owin;
using RequestDocuments.Api.Controllers;
using RequestDocuments.Web;
using Hangfire;
...
namespace RequestDocuments.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in RequestDocumentsWebModule)
